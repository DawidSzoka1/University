...
//     version 1.14.0
//     from Assets/playerAssets/FinalCharacterController/Input/PlayerControls.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/playerAssets/FinalCharacterController/Input/PlayerControls.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        {
            ...
            ""id"": ""56da21a3-9f45-44b8-ab79-28f33fc7cf20"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Value"",
                    ""id"": ""6ae7a204-f438-44d0-8d2f-1ccdfe0a2b46"",
                ...
                },
                {
                    ""name"": ""Look"",
                    ""type"": ""Value"",
                    ""id"": ""4261c9e2-44ff-4f4f-be38-a575a19321ec"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Switch"",
                    ""type"": ""Button"",
                    ""id"": ""bec21786-0595-4247-af5b-f52efeba9649"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""ToggleSprint"",
                    ""type"": ""Button"",
                    ""id"": ""3adcd19f-9a0a-479f-bafa-0075ab27c766"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""b95b88e6-7788-4df0-b8fc-08b585ea34e6"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Attack"",
                    ""type"": ""Button"",
                    ""id"": ""68911acf-0dae-4bd5-927d-70cec0ee3499"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""04ceffdb-e7fe-4192-93e0-82198be6ae4f"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""56744dd0-e8e5-478a-839e-2549f49a93f6"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""4e301df3-973a-443d-b29d-0ff3420b961a"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""24a93d2c-697d-473a-8583-8d41aba2b8fe"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""a4313a47-095f-45d1-bf76-fdf21eb9497e"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""a2307632-b9a6-472b-aa6e-fd3d98fde55e"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""63dc93c2-6a27-410f-98f1-17d38a8de4ea"",
                    ""path"": ""<Keyboard>/v"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""d0b9585c-9e36-46a0-ace8-0c5952f549f7"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a4a4c7da-7a1a-4aaa-b300-e4d866544c75"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""ef1b04cd-7e97-4d13-b32e-5376c700cdaa"",
    ...
    ""controlSchemes"": []
            ...
            m_PlayerLocomotionMap_Switch = m_PlayerLocomotionMap.FindAction("Switch", throwIfNotFound: true);
        ...
        private readonly InputAction m_PlayerLocomotionMap_Switch;
        ...
        public struct PlayerLocomotionMapActions
        {
            ...
            /// <summary>
            /// Provides access to the underlying input action "PlayerLocomotionMap/Switch".
            /// </summary>
            public InputAction @Switch => m_Wrapper.m_PlayerLocomotionMap_Switch;
            /// <summary>
