...
author: |
  ...
  Wydział Informatyki rok 2 semestr 4 
date: "`r Sys.Date()`"
output:
   html_document:
    toc: true
...
- współczynnik asymetri (A) // do zrobienia
- współczynnik koncentracji (kurtosis)
- współczynnik ekscesu// do zrobionia
- współczynnik Giniego (gini)
...
- współczynnik koncentracji // do zrobienia 
